"""
Django settings for hexaclimate project.
"""
...
WSGI_APPLICATION = 'hexaclimate.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='hexaclimate'),
